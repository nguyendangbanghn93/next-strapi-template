...
async function configViews() {
  ...
  await configView(
    "configuration_content_types::application::global.global",
    require("../../views/global.json")
  );
  await configView(
    "configuration_components::shared.seo",
    require("../../views/shared.seo.json")
  );
  await configView(
    "configuration_components::shared.meta",
    require("../../views/shared.meta.json")
  );
}
...
module.exports = async () => {
  ...
  // console.log("fistyun...", shouldImportSeedData);
